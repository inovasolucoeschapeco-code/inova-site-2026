    ...
    <Layout>
          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                ...
                className="bg-primary hover:bg-primary/90 text-white h-14 px-8 text-sm uppercase tracking-widest font-bold rounded-none border border-transparent hover:border-white/20 transition-all cursor-pointer"
              >
                Falar com Consultor
              </Button>
              <Link href="/solucoes">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="group relative bg-white border border-border hover:border-primary transition-colors duration-300 h-full flex flex-col">
              ...
              <div className="p-8 flex-grow flex flex-col">
                ...
                <Button 
                  onClick={() => openLeadModal("Solicitar Orçamento")}
                  variant="outline" 
                  className="w-full border-border hover:border-primary hover:text-primary uppercase text-xs font-bold tracking-widest rounded-none cursor-pointer"
                >
                  Solicitar Orçamento
                </Button>
              </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <Button 
                onClick={() => openLeadModal("Falar com Consultor")}
                className="mt-10 bg-primary hover:bg-primary/90 text-white h-12 px-8 text-sm uppercase tracking-widest font-bold rounded-none cursor-pointer"
              >
                Falar com Consultor
              </Button>
            </div>
          ...
          <div className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
            <div className="bg-white p-8 border border-border relative">
              ...
              <p className="text-lg text-muted-foreground mb-6 relative z-10 italic">
                Nós escolhemos trabalhar com a Inova pela credibilidade regional e por estar sempre ao lado do cliente em seu posicionamento. É um parceiro certificado pelo fabricante e tem histórico positivo em projetos já realizados.
              </p>
            ...
            <div className="bg-white p-8 border border-border relative">
              <div className="text-primary text-6xl font-serif absolute top-4 left-4 opacity-20">"</div>
              <p className="text-lg text-muted-foreground mb-6 relative z-10 italic">
                A modernização da nossa infraestrutura de rede era um projeto estratégico e complexo, envolvendo 10 unidades em todo o Brasil. A Inova em parceria com a Sercompe não apenas entregou uma solução robusta com a tecnologia Aruba, mas também demonstrou um comprometimento exemplar.
              </p>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full overflow-hidden">
      ...
      <section className="py-24 bg-primary text-white text-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <Button 
            onClick={() => openLeadModal("Falar com Consultor")}
            className="bg-white text-primary hover:bg-gray-100 h-16 px-10 text-base uppercase tracking-widest font-bold rounded-none cursor-pointer"
          >
            Falar com Consultor
          </Button>
        </div>
