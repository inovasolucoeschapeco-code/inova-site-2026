            ...
            <div key={pillar.id} className={`flex flex-col lg:flex-row gap-12 items-center ${index % 2 === 1 ? 'lg:flex-row-reverse' : ''}`}>
              ...
              <div className="w-full lg:w-1/2">
                ...
                <Button 
                  ...
                  className="bg-foreground hover:bg-primary text-white h-12 px-8 text-sm uppercase tracking-widest font-bold rounded-none transition-colors group cursor-pointer"
                >
      ...
      <section className="py-20 bg-gray-100 border-t border-border">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button 
            ...
            variant="outline" 
            className="border-foreground text-foreground hover:bg-foreground hover:text-white h-12 px-8 text-sm uppercase tracking-widest font-bold rounded-none cursor-pointer"
          >
            Falar com Consultor
          </Button>
        </div>
